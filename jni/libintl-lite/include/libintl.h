...
LIBINTL_LITE_API libintl_lite_bool_t ndtextdomain(const char* domain, const char* moFilePath);

LIBINTL_LITE_API libintl_lite_bool_t ind_textdomain_codeset(const char* domain, const char* moFilePath);
