...
void cPath :: Editor_State_Update( void )
{
	...
	// selected segment
	CEGUI::Combobox *combobox = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild("path_selected_segment" ));
	combobox->resetList();
	...
	// x1
	CEGUI::Editbox *editbox_x1 = static_cast<CEGUI::Editbox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "path_segment_x1" ));
	editbox_x1->setText( float_to_string( m_segments[m_editor_selected_segment].m_x1, 6, 0 ) );
	// y1
	CEGUI::Editbox *editbox_y1 = static_cast<CEGUI::Editbox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "path_segment_y1" ));
	editbox_y1->setText( float_to_string( m_segments[m_editor_selected_segment].m_y1, 6, 0 ) );
	// x2
	CEGUI::Editbox *editbox_x2 = static_cast<CEGUI::Editbox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "path_segment_x2" ));
	editbox_x2->setText( float_to_string( m_segments[m_editor_selected_segment].m_x2, 6, 0 ) );
	// y2
	CEGUI::Editbox *editbox_y2 = static_cast<CEGUI::Editbox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "path_segment_y2" ));
