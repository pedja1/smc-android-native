...
void cMenu_Start :: Init_GUI( void )
{
	...
	for( vector<cCampaign *>::const_iterator itr = pCampaign_Manager->objects.begin(); itr != pCampaign_Manager->objects.end(); ++itr )
	{
		...
		CEGUI::ListboxTextItem *item = new CEGUI::ListboxTextItem( campaign->m_name.c_str() );
		// is in game dir
...
// show all worlds in debug builds
		...
		CEGUI::ListboxTextItem *item = new CEGUI::ListboxTextItem( world->m_name.c_str() );
		// is in game dir
		if( world->m_user == 0 )
		{
			item->setTextColours( CEGUI::Colour( 1, 0.8f, 0.6f ) );
...
void cMenu_Start :: Get_Levels( std::string dir, CEGUI::Colour color )
{
	...
	for( vector<std::string>::iterator itr = lvl_files.begin(); itr != lvl_files.end(); ++itr )
	{
		...
		// create listbox item
		CEGUI::ListboxTextItem *item = new CEGUI::ListboxTextItem( lvl_name.c_str() );
...
bool cMenu_Start :: Campaign_Select( const CEGUI::EventArgs &event )
{
	...
	if( item )
	{
		...
		editbox_campaign_description->setText( pCampaign_Manager->Get_from_Name( item->getText().c_str() )->m_description.c_str());
	}
	// clear
	else
	{
...
bool cMenu_Start :: World_Select( const CEGUI::EventArgs &event )
{
	...
	if( item )
	{
		...
		editbox_world_description->setText(pOverworld_Manager->Get_from_Name( item->getText().c_str() )->m_description->m_comment.c_str() );
	}
	// clear
	else
	{
...
void cMenu_Options :: Init_GUI_Game( void )
{
	...
	m_game_combo_always_run = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "game_combo_always_run" ));
	...
	m_game_spinner_camera_hor_speed = static_cast<CEGUI::Spinner *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "game_spinner_camera_hor_speed" ));
	...
	m_game_spinner_camera_ver_speed = static_cast<CEGUI::Spinner *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "game_spinner_camera_ver_speed" ));
	...
	m_game_combo_language = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "game_combo_language" ));
	...
	m_game_combo_menu_level = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "game_combo_menu_level" ));
...
void cMenu_Options :: Init_GUI_Video( void )
{
	...
	// Resolution
	CEGUI::Window *text_resolution = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_text_resolution" ));
	text_resolution->setText( UTF8_("Resolution") );

	m_video_combo_resolution = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_combo_resolution" ));
	...
	// Bpp
	CEGUI::Window *text_bpp = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_text_bpp" ));
	text_bpp->setText( UTF8_("Bpp") );

	m_video_combo_bpp = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_combo_bpp" ));
	...
	// Fullscreen
	CEGUI::Window *text_fullscreen = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_text_fullscreen" ));
	text_fullscreen->setText( UTF8_("Fullscreen") );

	m_video_combo_fullscreen = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_combo_fullscreen" ));
	...
	// VSync
	CEGUI::Window *text_vsync = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_text_vsync" ));
	text_vsync->setText( UTF8_("VSync") );

	m_video_combo_vsync = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_combo_vsync" ));
	...
	// FPS Limit
	CEGUI::Window *text_fps_limit = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_text_fps_limit" ));
	text_fps_limit->setText( UTF8_("FPS Limit") );

	m_video_spinner_fps_limit = static_cast<CEGUI::Spinner *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_spinner_fps_limit" ));
	...
	// Geometry quality
	CEGUI::Window *text_geometry_quality = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_text_geometry_quality" ));
	text_geometry_quality->setText( UTF8_("Geometry Quality") );

	m_video_slider_geometry_quality = static_cast<CEGUI::Slider *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_slider_geometry_quality" ));
	...
	// Texture quality
	CEGUI::Window *text_texture_quality = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_text_texture_quality" ));
	text_texture_quality->setText( UTF8_("Texture Quality") );

	m_video_slider_texture_quality = static_cast<CEGUI::Slider *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_slider_texture_quality" ));
	...
	// Reset
	CEGUI::PushButton *button_reset = static_cast<CEGUI::PushButton *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_button_reset" ));
	...
	// Apply
	CEGUI::PushButton *button_apply = static_cast<CEGUI::PushButton *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_button_apply" ));
	...
	// Recreate Cache
	CEGUI::PushButton *button_recreate_cache = static_cast<CEGUI::PushButton *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "video_button_recreate_cache" ));
...
void cMenu_Options :: Init_GUI_Audio( void )
{
	...
	// Audio Hz
	CEGUI::Window *text_hz = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "audio_text_hz" ));
	text_hz->setText( UTF8_("Hertz (Hz)") );
	text_hz->setTooltipText( UTF8_("You should only change the value if the audio is scratchy.") );

	m_audio_combo_hz = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "audio_combo_hz" ));
	...
	// Music
	CEGUI::Window *text_music = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "audio_text_music" ));
	...
	m_audio_combo_music = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "audio_combo_music" ));
	...
	// music volume slider
	m_audio_slider_music = static_cast<CEGUI::Slider *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "audio_slider_music_volume" ));
	...
	// Sounds
	CEGUI::Window *text_sound = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "audio_text_sound" ));
	text_sound->setText( UTF8_("Sound") );
	text_sound->setTooltipText( UTF8_("Enable to play Sounds.") ) ;

	m_audio_combo_sounds = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "audio_combo_sounds" ));
	...
	// sound volume slider
	m_audio_slider_sound = static_cast<CEGUI::Slider *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "audio_slider_sound_volume" ));
	...
	// Reset
	CEGUI::PushButton *button_reset = static_cast<CEGUI::PushButton *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "audio_button_reset" ));
...
void cMenu_Options :: Init_GUI_Keyboard( void )
{
	...
	// Keyboard listbox
	CEGUI::Window *text_keyboard_shortcuts = pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "keyboard_text_shortcuts" );
	text_keyboard_shortcuts->setText( UTF8_("Shortcuts") );

	CEGUI::MultiColumnList *listbox_keyboard = static_cast<CEGUI::MultiColumnList *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "keyboard_listbox" ));
	...
	CEGUI::Window *text_keyboard_scroll_speed = pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "keyboard_text_scroll_speed" );
	text_keyboard_scroll_speed->setText( UTF8_("Scroll Speed") );

	CEGUI::Slider *slider_scoll_speed = static_cast<CEGUI::Slider *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "keyboard_slider_scroll_speed" ));
	...
	// Reset Keyboard
	CEGUI::PushButton *button_reset_keyboard = static_cast<CEGUI::PushButton *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "keyboard_button_reset" ));
...
void cMenu_Options :: Init_GUI_Joystick( void )
{
	...
	CEGUI::Window *text_joystick_sensitivity = pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_text_sensitivity" );
	text_joystick_sensitivity->setText( UTF8_("Sensitivity") );	

	// Joystick analog jump text
	CEGUI::Window *text_joystick_analog_jump = pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_text_analog_jump" );
	text_joystick_analog_jump->setText( UTF8_("Analog Jump") );
	
	// Joystick name
	CEGUI::Window *text_joystick_name = pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_text_name" );
	...
	CEGUI::Combobox *combo_joy = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_combo" ));
	...
	CEGUI::Slider *slider_joy_sensitivity = static_cast<CEGUI::Slider *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_slider_sensitivity" ));
	...
	CEGUI::Combobox *combo_joy_analog_jump = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_combo_analog_jump" ));
	...
	CEGUI::Window *text_joystick_axis_hor = pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_text_axis_hor" );
	text_joystick_axis_hor->setText( UTF8_("Axis Hor") );

	CEGUI::Spinner *spinner_joystick_axis_hor = static_cast<CEGUI::Spinner *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_spinner_axis_hor" ));
	...
	CEGUI::Window *text_joystick_axis_ver = pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_text_axis_ver" );
	text_joystick_axis_ver->setText( UTF8_("Ver") );

	CEGUI::Spinner *spinner_joystick_axis_ver = static_cast<CEGUI::Spinner *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_spinner_axis_ver" ));
	...
	CEGUI::Window *text_joystick_shortcuts = pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_text_shortcuts" );
	text_joystick_shortcuts->setText( UTF8_("Shortcuts") );

	CEGUI::MultiColumnList *listbox_joystick = static_cast<CEGUI::MultiColumnList *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_listbox" ));
	...
	// Reset Joystick
	CEGUI::PushButton *button_reset_joystick = static_cast<CEGUI::PushButton *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "joystick_button_reset" ));
...
void cMenu_Options :: Init_GUI_Editor( void )
{
	...
	// show item images
	CEGUI::Window *text_editor_show_item_images = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "editor_text_show_item_images" ));
	text_editor_show_item_images->setText( UTF8_("Show images") );

	m_game_combo_editor_show_item_images = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "editor_combo_show_item_images" ));
	...
	// item image size
	CEGUI::Window *text_editor_item_image_size = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "editor_text_item_image_size" ));
	text_editor_item_image_size->setText( UTF8_("Item image size") );

	m_game_spinner_editor_item_image_size = static_cast<CEGUI::Spinner *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "editor_spinner_item_image_size" ));
	...
	CEGUI::Window *text_editor_mouse_auto_hide = static_cast<CEGUI::Window *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "editor_text_mouse_auto_hide" ));
	text_editor_mouse_auto_hide->setText( UTF8_("Auto-Hide Mouse") );

	m_game_combo_editor_mouse_auto_hide = static_cast<CEGUI::Combobox *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "editor_combo_mouse_auto_hide" ));
	...
	// Reset Editor
	CEGUI::PushButton *button_reset_editor = static_cast<CEGUI::PushButton *>(pGuiSystem->getDefaultGUIContext().getRootWindow()->getChild( "editor_button_reset" ));
